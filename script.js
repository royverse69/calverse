// API keys are removed from the client-side for security.
...
function renderAllPages() {
    ...
    document.getElementById('about').innerHTML = `
        <div class="bg-card border-card p-8 rounded-2xl glass-card text-center animate-fade-in">
            ...
            <p class="text-sub leading-relaxed max-w-2xl mx-auto">Calverse is your personal AI-powered nutrition and health assistant. Our mission is to make healthy living accessible and understandable for everyone. Whether you're tracking calories, looking for healthy recipes, or need to understand your health metrics, Calverse provides you with the tools and insights to achieve your wellness goals. We believe that with the right information, anyone can make better choices for a healthier, happier life.</p>
        </div>`;
        ...
        <div class="bg-card border-card p-8 rounded-2xl glass-card max-w-3xl mx-auto animate-fade-in">
            ...
            <div id="faq-accordion" class="space-y-4">
                <div class="accordion-item border-card border rounded-lg">
                    ...
                    <div class="accordion-content px-4 pb-4 text-sub"><p class="pt-2">Our nutrition analysis is powered by advanced AI models. While we strive for high accuracy, the data should be considered an estimate. For medical purposes, please consult a certified nutritionist or doctor.</p></div>
                </div>
                <div class="accordion-item border-card border rounded-lg">
                    <button class="accordion-header w-full text-left p-4 font-semibold flex justify-between items-center text-main"><span>Is my data private?</span><i data-lucide="chevron-down" class="transform transition-transform text-sub"></i></button>
                    <div class="accordion-content px-4 pb-4 text-sub"><p class="pt-2">Yes, your privacy is our priority. We only store your name locally on your device. All API requests are proxied securely, and we do not store your health data on our servers.</p></div>
                </div>
                <div class="accordion-item border-card border rounded-lg">
                    ...
                    <div class="accordion-content px-4 pb-4 text-sub"><p class="pt-2">The health calculators and basic UI will function offline. However, any feature that requires AI analysis (like nutrition lookup, meal analysis, and recipe generation) requires an active internet connection to communicate with our server.</p></div>
                </div>
            </div>
        </div>`;
...
async function callGeminiApi(prompt, type = 'general') {
    ...
    try {
        ...
        showModal("Function Error", "An error occurred while communicating with the server. Please check the console for details.");
        return null;
    }
}
